<template>
  <div>
    ...
    >
      <div
        class="bg-white rounded-2xl w-full max-w-lg max-h-[90vh] flex flex-col overflow-hidden shadow-2xl relative"
      >
        <!-- Header -->
            ...
            <div class="flex flex-wrap gap-2">
              ...
              >
                ...
                <button
                  ...
                  class="absolute top-1 right-1 bg-black bg-opacity-50 text-white rounded-full w-5 h-5 flex items-center justify-center hover:bg-opacity-70"
                >
        ...
        <div class="p-4 border-t bg-gray-50 flex justify-end space-x-2">
          <button
            @click="closeModal"
            class="px-6 py-2.5 rounded-xl font-bold text-gray-700 hover:bg-gray-200 transition"
          >
            취소
          </button>
          <button
...
const submitReview = async () => {
  ...
  try {
    ...
    closeModal()
    emit('success')
    showAlert(isEdit.value ? '리뷰가 수정되었습니다.' : '리뷰가 등록되었습니다.', 'success')
  } catch (error) {
